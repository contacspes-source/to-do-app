...
const EXTRA: Recipe[] = [
  ...
  { id: "e-omelette-espinaca", meal: "desayuno", name: "Omelette de espinaca y queso", protein: "~30 g", ingredients: [{ item: "Huevo", qty: "3 pzas", cat: "Proteínas" }, { item: "Espinaca", qty: "1 taza", cat: "Verduras" }, { item: "Queso panela", qty: "40 g", cat: "Lácteos" }, { item: "Tortilla de maíz", qty: "1 pza", cat: "Cereales y granos" }], prep: "Bate los huevos, agrega espinaca y queso, cuaja en sartén.", avoidsTomato: true },
  ...
  { id: "e-pasta-pollo-pesto", meal: "comida", name: "Pasta con pollo al pesto", protein: "~42 g", ingredients: [{ item: "Pasta", qty: "1 taza cocida", cat: "Cereales y granos" }, { item: "Pechuga de pollo", qty: "150 g", cat: "Proteínas" }, { item: "Pesto", qty: "1 cda", cat: "Despensa" }, { item: "Espinaca", qty: "1 taza", cat: "Verduras" }], prep: "Saltea el pollo, mezcla con pasta, pesto y espinaca.", avoidsTomato: true },
  ...
  { id: "e-albondigas", meal: "comida", name: "Albóndigas de res con calabaza", protein: "~40 g", ingredients: [{ item: "Carne molida de res", qty: "150 g", cat: "Proteínas" }, { item: "Calabaza", qty: "1 taza", cat: "Verduras" }, { item: "Arroz", qty: "1 taza", cat: "Cereales y granos" }, { item: "Cebolla", qty: "¼ pza", cat: "Verduras" }], prep: "Forma albóndigas, cuécelas con calabaza en caldo ligero; sirve con arroz.", avoidsTomato: true },
  ...
  // --- Cenas ---
  { id: "e-quesadilla-champinon", meal: "cena", name: "Quesadillas de champiñón", protein: "~26 g", ingredients: [{ item: "Tortilla de maíz", qty: "3 pzas", cat: "Cereales y granos" }, { item: "Champiñón", qty: "1 taza", cat: "Verduras" }, { item: "Queso panela", qty: "80 g", cat: "Lácteos" }], prep: "Saltea champiñones, arma quesadillas y dora en comal.", avoidsTomato: true },
  ...
  { id: "e-omelette-claras", meal: "cena", name: "Omelette de claras y verduras", protein: "~28 g", ingredients: [{ item: "Clara de huevo", qty: "5 pzas", cat: "Proteínas" }, { item: "Espinaca", qty: "1 taza", cat: "Verduras" }, { item: "Champiñón", qty: "½ taza", cat: "Verduras" }, { item: "Queso panela", qty: "40 g", cat: "Lácteos" }], prep: "Cuaja las claras con la verdura y el queso.", tags: ["rapida"], avoidsTomato: true },
  ...
  { id: "e-edamames", meal: "colacion", name: "Edamames con limón", protein: "~12 g", ingredients: [{ item: "Edamame", qty: "1 taza", cat: "Verduras" }, { item: "Limón", qty: "1 pza", cat: "Frutas" }], prep: "Cuece al vapor y exprime limón.", tags: ["rapida"], avoidsTomato: true },
...
Object.assign(MACROS, {
  ...
  "e-edamames": { kcal: 150, p: 12, c: 12, f: 6 }, "e-galleta-arroz-mani": { kcal: 220, p: 9, c: 28, f: 9 },
});
